...
@dmark(with_state=True, after=['test_01_06'], tags='layer2')
...
@dmark(with_state=True, after=['test_01_08'], tags='layer2')
...
@dmark(with_state=True, after=['test_02_02'], tags='layer3')
...
@dmark(with_state=True, after=['test_02_06'], tags='layer3')
...
@dmark(with_state=True, after=['test_02_08'], tags='layer3')
...
@dmark(with_state=True, after=['test_02_04'], tags='layer3')
...
# ---------------------------------------------------------------------------
@dmark(with_state=True, after=['test_03_01'], tags='layer4,capA')
...
@dmark(with_state=True, after=['test_03_04'], tags='layer4,capB')
def test_04_04(state): return run('test_04_04', state, deps=['test_03_04'])

@dmark(with_state=True, after=['test_03_07'], tags='layer4,capB')
...
# ---------------------------------------------------------------------------
@dmark(with_state=True, after=['test_04_02'], tags='layer5')
...
# ---------------------------------------------------------------------------
@dmark(with_state=True, after=['test_05_02'], tags='layer6')
